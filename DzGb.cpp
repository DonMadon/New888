...
class Miniven : public Bus, public PassengerCar {

public:
  Miniven(std::string& company, std::string& model) : Car(company, model), Bus(company, model), PassengerCar(company,model) {}
};
